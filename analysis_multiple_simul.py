...
def plot_cap_frac_vs_T(T_range, dMOT_range, img_folder):
    """
...
def plot_density_vs_T(T_range, dMOT_range, img_folder):
    """
...
def plot_cap_frac_vs_dMOT(T_range, dMOT_range, img_folder):
    """
...
def plot_density_vs_dMOT(T_range, dMOT_range, img_folder):
    """
...
if __name__ == "__main__":
    plot_cap_frac_vs_T(T_range, dMOT_range, img_folder)
    plot_density_vs_T(T_range, dMOT_range, img_folder)
    plot_cap_frac_vs_dMOT(T_range, dMOT_range, img_folder)
    plot_density_vs_dMOT(T_range, dMOT_range, img_folder)
    plot_3d_TdMOTconc()
